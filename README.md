...
- **🔗 [Arduino-Stepper-Motor-Controller-with-Joystick](https://github.com/rembov/Arduino-Stepper-Motor-Controller-with-Joystick)**<br>
  Контроллер шагового двигателя на **Arduino Uno/Nano** с управлением через аналоговый джойстик. При отклонении джойстика двигатель поворачивается на 180° в соответствующую сторону. Поддерживает микрошаги, плавное движение и защиту от повторных срабатываний.
...
- **🔗 [Epstein-cipher](https://github.com/rembov/Epstein-cipher)**  
  Реализация шифра с пользовательским алгоритмом кодирования и декодирования текста.
